...
\subsection{Justificación de la Tipografía}

Se han elegido las tipografías \textbf{San Francisco} y \textbf{Roboto} (Figura ~\ref{fig:tipografia-ejemplo}) en el proyecto porque son fuentes modernas, versátiles y especialmente diseñadas para entornos digitales. San Francisco y Roboto son las tipografías nativas de iOS y Android respectivamente, lo que garantiza una integración perfecta con cada sistema operativo y una experiencia visual coherente y profesional para el usuario. Además, Roboto se emplea también en la web de realidad aumentada y mantiene la uniformidad y la legibilidad en todos los dispositivos (IOS y Android). 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figs/tipografia.png}
    \caption{Ejemplo de las tipografías San Francisco y Roboto.}
    \label{fig:tipografia-ejemplo}
\end{figure}

\subsection{Wireframes}

Los wireframes son una herramienta fundamental en el proceso de diseño de la interfaz de usuario, ya que permiten visualizar la estructura y disposición de los elementos antes de entrar en detalles estéticos. En el caso de \textit{DONA'm MÓN}, se han creado wireframes para las pantallas principales, siendo estas: el mapa interactivo, las fichas de mujeres y lugares, las rutas temáticas y el perfil de usuario. Estos wireframes se han desarrollado utilizando la herramienta \textbf{Canva}~\cite{canva} y se muestran en la Figura~\ref{fig:wireframes-principales}.
\begin{figure}[H]
\centering
\begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/wireframe1.jpg}
    \caption{Wireframe 1: Mapa interactivo}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/wireframe2.jpg}
    \caption{Wireframe 2: Ficha de mujer}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/wireframe3.jpg}
    \caption{Wireframe 3: Rutas temáticas}
\end{subfigure}
...
\begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/wireframe4.jpg}
    \caption{Wireframe 4: Perfil de usuario}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.325\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/wireframe5.jpg}
    \caption{Wireframe 5: Ficha de lugar}
\end{subfigure}

\vspace{0.5cm}

\caption{Wireframes de las pantallas principales de \textit{DONA'm MÓN}}
...
\subsection{Diagrama de secuencia del caso de uso 19: Gestionar áreas de investigación}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/caso20.png}
    \caption{Diagrama de secuencia del caso de uso 19: Gestionar áreas de investigación}
\end{figure}