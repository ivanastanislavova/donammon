...
\item[RF44:] La aplicación debe calcular distancias precisas utilizando la fórmula de Haversine.
...
\begin{itemize}
    ...
    \item[F8.] Activar realidad aumentada al acercarse a un punto.
    ...
    \item[F12.] Visualizar imágenes ampliadas en modal al hacer tap sobre ellas.
    \item[F13.] Compartir información de lugares vía aplicaciones nativas del dispositivo.
\end{itemize}
...
\begin{itemize}
    \item[F15.] Registrar un nuevo usuario mediante nombre de usuario y contraseña.
    \item[F16.] Iniciar sesión en la aplicación.
    \item[F17.] Mantener la sesión activa entre usos.
    \item[F18.] Permitir al usuario editar su nombre de usuario.
    \item[F19.] Cerrar sesión manualmente.
    \item[F20.] Filtrar lugares por área de investigación y estado de visita.
  \item[F21.] Buscar mujeres y lugares por nombre en tiempo real.
  \item[F22.] Sincronizar estado de filtros entre diferentes pantallas de la aplicación.
\end{itemize}
...
\item[F38.] Reiniciar el progreso de rutas ya completadas para repetir la experiencia.
...
\item[F45.] Filtrar lugares por área de investigación y estado de visita.
\item[F46.] Buscar mujeres y lugares por nombre.
\item[F47.] Calcular y mostrar distancias precisas con fórmula de Haversine.
