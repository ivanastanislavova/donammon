...
\begin{landscape}
    \begin{figure}[H]
        \centering
        \includegraphics[width=1.5\textwidth]{figs/diagrama_actividad_usuario_registrado.png}
...
\begin{landscape}
    \begin{figure}[H]
        \centering
        \includegraphics[width=1.5\textwidth]{figs/diagrama_actividad_administrador.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/estado_usuario_no_registrado.png}
...
\begin{landscape}
    ...
    \centering
    \makebox[\paperwidth]{%
        \includegraphics[width=1.2\paperwidth]{figs/estado_usuario_registrado.png}
    }
    \par\vspace{1ex}
