...
\hline
\textbf{Propósito} & Permitir que el usuario acceda a su cuenta personal mediante nombre de usuario y contraseña. \\
\hline
...
\textbf{Actores} & Usuario no registrado (principal), Sistema (secundario) \\
\hline
\textbf{Propósito} & Permitir que nuevos usuarios creen una cuenta personal mediante un formulario con nombre de usuario, correo electrónico, fecha de nacimiento y contraseña. \\
\hline
\textbf{Resumen} & Este caso de uso describe el proceso por el cual un usuario puede registrarse en la aplicación. \\
\hline
\textbf{Tipo} & Primario \\
\hline
\textbf{Referencias} & RF24, RNF21, RNF22 \\
\hline
\textbf{Precondiciones} & El sistema debe estar operativo y conectado. El usuario no debe tener una cuenta registrada con ese correo o nombre de usuario. \\
\hline
...
\textbf{Tipo} & Primario \\
\hline
\textbf{Referencias} & RF4, RF5, RF12, RF13, RF36 \\
\hline
...
\clearpage
\subsection{Caso de uso 9: Visualizar contenido RA}
...
\textbf{Tipo} & Primario \\
\hline
\textbf{Referencias} & RF41, RF6, RF20 \\
\hline
...
\textbf{Tipo} & Primario \\
\hline
\textbf{Referencias} & RF14, RF42, RF13 \\
\hline
...
\textbf{Tipo} & Primario \\
\hline
\textbf{Referencias} & RF26, RF28, RF29 \\
\hline
\textbf{Precondiciones} & El administrador debe haber iniciado sesión correctamente en el panel de administración. \\
\hline
...
\clearpage
\subsection{Caso de uso 19: Gestionar áreas de investigación}

\begin{table}[H]
\centering
\caption{Caso de uso 19 - Gestionar áreas de investigación}
\begin{tabular}{|p{4.5cm}|p{10.5cm}|}
\hline
...
\begin{figure}[H]
    ...
    \label{fig:diagrama-actividad-usuario-no-registrado}
\end{figure}

% Aquí es donde probablemente se inserta la página en blanco
% Solución: comienza landscape justo con una nueva figura
...
\begin{landscape}
    ...
    \begin{center}
        \includegraphics[width=1.45\textwidth]{figs/diagrama_actividad_usuario_registrado.png}
        \captionof{figure}{Diagrama de actividad de usuario registrado}
        \label{fig:diagrama-actividad-usuario-registrado}
        \vspace{2cm}

        \includegraphics[width=1.45\textwidth]{figs/diagrama_actividad_administrador.png}
        \captionof{figure}{Diagrama de actividad del panel de administración}
        \label{fig:diagrama-actividad-administrador}
    \end{center}
\end{landscape}
...
A continuación se presentan \textbf{tres diagramas de estado} que describen el comportamiento de los diferentes tipos de usuarios del sistema. El primer diagrama corresponde al \textbf{usuario no registrado}, mostrando las transiciones básicas desde el acceso inicial hasta el registro o inicio de sesión. El segundo diagrama representa el \textbf{usuario registrado} y, debido a la complejidad y extensión de las funcionalidades disponibles, se ha dividido en \textbf{dos partes} para garantizar una visualización óptima y facilitar su comprensión. El tercer diagrama ilustra el comportamiento del \textbf{administrador} del sistema, incluyendo todas las operaciones de gestión y mantenimiento disponibles desde el panel administrativo.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figs/estado_usuario_no_registrado.png}
...
\begin{landscape}
    \begin{figure}[H]
        \centering
        \vspace*{2cm}
        \includegraphics[width=1.2\paperwidth]{figs/diagrama1.png}
        \caption{Diagrama de estado de usuario registrado 1}
        \label{fig:diagrama-estado-usuario-registrado-1}
    \end{figure}
\end{landscape}
...
\begin{landscape}
    \begin{figure}[H]
        \centering
        \vspace*{4cm}
        \includegraphics[width=1.2\paperwidth]{figs/diagrama2.png}
        \caption{Diagrama de estado de usuario registrado 2}
        \label{fig:diagrama-estado-usuario-registrado-2}
    \end{figure}
\end{landscape}
...
\begin{landscape}
    \begin{figure}[H]
        \centering
        \vspace*{4cm} % Ajusta este valor para mover más o menos hacia abajo
        \includegraphics[width=1.2\paperwidth]{figs/estado_administrador.png}
        
        \caption{Diagrama de estado del panel de administración}
    \end{figure}
\end{landscape}
