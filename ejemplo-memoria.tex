...
Aquest Treball de Fi de Grau aborda el repte de donar visibilitat a dones històricament rellevants a València, les aportacions de les quals, encara que presents en l\textquotesingle espai urbà, són en gran part desconegudes per la ciutadania. Aquesta manca de reconeixement limita la construcció de referents per a les futures generacions i evidencia la necessitat d\textquotesingle eines innovadores que unisquen tecnologia, educació e igualtat.
